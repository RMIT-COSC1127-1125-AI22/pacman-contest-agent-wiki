...
Remember you can explain not just what worked and made it to the final submission, but also what you implemented, tried it but did not make it to the final submission. 

**NOTE:**  When you explain that you used X or Y technique, you should NOT explain here what the technique in detail, but rather why you use it, how you use it and applied to your case, what the results were etc. The Wiki is not, for instance, a place to explain to the reader how Monte Carlo Tree Search (MCTS) works, just tell us how you used it and how you applied it in your team.
